...
* 版本 : generic,release @ 11.0.0-20190915
* 游戏版本 : 1.14.4
* 测试版本 : vanilla-1.13.2(旧版) , spigot-1.13.2(旧版) , vanilla-1.14.4 , spigot-1.14.4
* 类型 : 原版模组
...
已知bug
====================================
- 新的存档在游戏开始前需要先执行event下的death函数(已临时在gamecheck中解决)
