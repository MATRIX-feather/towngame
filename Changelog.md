...
* 20191013:
    ...
    *   更改了道具的使用方式
        *   详细信息:现在道具分为两种:
            *   vanilla :   tg原生类型道具(右键使用)
            *   legacy  :   采用旧版识别方式的道具(Q键丢出)
        *   目前所有的tg道具均更改为vanilla类型,legacy类型正在考虑要不要保留
    *   现在的道具将不可堆叠
    *   游戏文案修改
* 20191014:
    *   补上了towngame材质包...
    *   文本界面修改
    *   **将大部分的文本改成了基于资源包语言文件的文本**
    +   现在将会在开始时给予玩家3秒*失明*效果
    +   添加了"一次性镭射"道具
    +   **现在的Towngame已准备好支持多语言了**
* 20191015:
    *   继续适配语言文件...
    *   放松了镭射枪的判定
    *   修复了第三次缩圈的语言文件错误
