...
*   20191022:(11.4.0-00000005)
    ...
    *   setpoint&gamecheck
        ...
        *   优化gamecheck指令结构
    *   DeathMatch
        *   **更改了DeathMatch的判断逻辑(从 > 至 >=)**
        *   现在将不允许把DeathMatch触发值设置为0
    *   修复了盔甲架数据错误
    *   文案修改

*   20191023(11.4.0-00000006)
...
*   20191024
    *   添加了材质包目录
    *   "玩家交换"道具修改:在交换后玩家获得漂浮效果

*   20191028(11.4.0-00000007-RC)
    *   炖菜:
