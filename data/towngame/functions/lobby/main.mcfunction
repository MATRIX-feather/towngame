...
bossbar set nife:tg_lobby_countdownbar name {"bold":true,"translate":"tg.lobby.bossbar","with":[{"color":"gold","bold":"true","score":{"objective":"nife_time","name":"nife_tglobby_bossbarnum"}} , {"translate":"tg.time.sec"} , {"bold":"true","color":"gold","score":{"objective":"nife_time","name":"nife_tglobby_countD"}} , {"translate":"tg.globalinsane"} , {"translate":"tg.comingsoon"} ]}
