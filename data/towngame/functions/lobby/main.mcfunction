...
execute if score nife_tg_insanemode nife_tg_settings matches 0 run bossbar set nife:tg_lobby_countdownbar name [{"translate":"tg.lobby.main.bbtext.1"},{"color":"gold","bold":"true","score":{"objective":"nife_time","name":"nife_tglobby_bossbarnum"}},{"translate":"tg.time.sec"},{"text":" | ","color":"gray","bold":true},{"translate":"tg.lobby.main.bbtext.2"},{"bold":"true","color":"gold","score":{"objective":"nife_stats","name":"player_count"}},{"color":"gray","bold":"true","text":" | "},{"color":"gold","bold":true,"translate":"tg.insanemode"},{"color":"gray","bold":true,"translate":"tg.off"}]
execute if score nife_tg_insanemode nife_tg_settings matches 1 run bossbar set nife:tg_lobby_countdownbar name [{"translate":"tg.lobby.main.bbtext.1"},{"color":"gold","bold":"true","score":{"objective":"nife_time","name":"nife_tglobby_bossbarnum"}},{"translate":"tg.time.sec"},{"text":" | ","color":"red","bold":true},{"translate":"tg.lobby.main.bbtext.2"},{"bold":"true","color":"gold","score":{"objective":"nife_stats","name":"player_count"}},{"color":"red","bold":"true","text":" | "},{"color":"gold","bold":true,"translate":"tg.insanemode"},{"color":"red","bold":true,"translate":"tg.on"}]
execute if score game1 nife_stats matches 0 at @e[tag=nife_tg_lobby] run title @a[distance=0..,gamemode=adventure] actionbar [{"color":"dark_aqua","bold":"true","text":"Towngame"},{"color":"gray","bold":"true","text":" | "},{"color":"gold","bold":"true","translate":"tg.lobby.main.bbtext.2"},{"color":"gold","score":{"objective":"nife_stats","name":"player_count"}},{"color":"gray","bold":"true","text":" | "},{"translate":"tg.lobby.main.queue_min","color":"gold","bold":"true"},{"color":"gold","score":{"objective":"nife_stats","name":"nife_tglobby_queuestart"}}]
