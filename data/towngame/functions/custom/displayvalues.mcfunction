...
tellraw @a[distance=0..] [{"translate":"tg.panel.head","color":"gray","bold":"true"},{"bold":"true","translate":"tg.custom.deathmatch","with":[{"translate":"tg.stage_deathmatch.title"},{"color":"gold","bold":"true","score":{"objective":"nife_stats","name":"dm_time"}}]}]
