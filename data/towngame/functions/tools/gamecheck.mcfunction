...
#检查
execute if score nife_game1_hascenter nife_stats matches 0 run tellraw @a [{"color":"dark_aqua","bold":"true","text":"Towngame"},{"color":"gray","bold":"true","text":" >> "},{"color":"red","bold":"true","translate":"tg.tools.gamecheck.failmsg.1"},{"color":"gold","bold":true,"translate":"tg.point.center"},{"color":"red","bold":true,"translate":"tg.tools.gamecheck.failmsg.2"}]
execute if score nife_game1_has_atk nife_stats matches 0 run tellraw @a [{"color":"dark_aqua","bold":"true","text":"Towngame"},{"color":"gray","bold":"true","text":" >> "},{"color":"red","bold":"true","translate":"tg.tools.gamecheck.failmsg.1"},{"color":"gold","bold":true,"translate":"tg.point.atk"},{"color":"red","bold":true,"translate":"tg.tools.gamecheck.failmsg.2"}]
execute if score nife_game1_has_def nife_stats matches 0 run tellraw @a [{"color":"dark_aqua","bold":"true","text":"Towngame"},{"color":"gray","bold":"true","text":" >> "},{"color":"red","bold":"true","translate":"tg.tools.gamecheck.failmsg.1"},{"color":"gold","bold":true,"translate":"tg.point.def"},{"color":"red","bold":true,"translate":"tg.tools.gamecheck.failmsg.2"}]
execute if score nife_game1_has_anv nife_stats matches 0 run tellraw @a [{"color":"dark_aqua","bold":"true","text":"Towngame"},{"color":"gray","bold":"true","text":" >> "},{"color":"red","bold":"true","translate":"tg.tools.gamecheck.failmsg.1"},{"color":"gold","bold":true,"translate":"tg.point.anv"},{"color":"red","bold":true,"translate":"tg.tools.gamecheck.failmsg.2"}]
execute if score nife_game1_has_lobby nife_stats matches 0 run tellraw @a [{"color":"dark_aqua","bold":"true","text":"Towngame"},{"color":"gray","bold":"true","text":" >> "},{"color":"red","bold":"true","translate":"tg.tools.gamecheck.failmsg.1"},{"color":"gold","bold":true,"translate":"tg.point.lobby"},{"color":"red","bold":true,"translate":"tg.tools.gamecheck.failmsg.2"}]
# 如果都好了
