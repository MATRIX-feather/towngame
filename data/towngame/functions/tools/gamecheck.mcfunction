...
execute if score nife_game1_has_lobby nife_stats matches 0 run tellraw @a [{"color":"dark_aqua","bold":"true","text":"Towngame"},{"color":"gray","bold":"true","text":" >> "},{"color":"red","bold":"true","text":"未找到大厅点,请确保该点被正确创建或已被加载"}]
# 如果都好了
