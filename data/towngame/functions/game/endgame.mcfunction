...
#播放声音
playsound towngame:generic.gameover.generic ambient @a[tag=nife_game_1]
#显示标题
...
kill @e[type=minecraft:trident,nbt={Item:{tag:{tg_tags:[trident]}}}]
...
execute if entity @a[tag=town_rank1] run tellraw @a [{"translate":"tg.panel.head","color":"gray","bold":true},{"translate":"tg.endgame.rank1","with":[{"color":"gold","bold":true,"selector":"@a[tag=nife_game_1,tag=town_rank1]"}],"color":"gold","bold":true}]
execute if entity @a[tag=town_rank2] run tellraw @a [{"translate":"tg.panel.head","color":"gray","bold":true},{"translate":"tg.endgame.rank2","with":[{"color":"blue","bold":true,"selector":"@a[tag=nife_game_1,tag=town_rank2]"}],"color":"blue","bold":true}]
execute if entity @a[tag=town_rank3] run tellraw @a [{"translate":"tg.panel.head","color":"gray","bold":true},{"translate":"tg.endgame.rank3","with":[{"color":"green","bold":true,"selector":"@a[tag=nife_game_1,tag=town_rank3]"}],"color":"green","bold":true}]
tellraw @a [{"translate":"tg.panel.head","color":"gray","bold":true}]
execute if entity @a[tag=town_rank1] run tellraw @a [{"color":"dark_aqua","bold":true,"translate":"tg.name"},{"color":"gray","bold":"true","translate":"tg.msg.head"},{"color":"green","bold":"true","translate":"tg.endgame.boardcast","with":[{"selector":"@a[tag=nife_game_1,tag=town_rank1]"}]}]
#endregion
#region 重置玩家数据
...
#善后工作
#  修复bossbar显示错误
bossbar set nife:game_1 players none
#   设置大厅队列时间
