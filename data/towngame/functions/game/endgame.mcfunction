...
#排名公告
tellraw @a [{"text":"| ","color":"gray","bold":"true"},{"translate":"tg.endgame.ranktitle"}]
tellraw @a [{"text":"| ","color":"gray","bold":"true"},{"translate":"tg.endgame.rank1","color":"gold","bold":true},{"color":"gold","bold":true,"selector":"@a[tag=nife_game_1,tag=town_rank1]"}]
tellraw @a [{"text":"| ","color":"gray","bold":"true"},{"translate":"tg.endgame.rank2","color":"blue","bold":true},{"color":"blue","bold":true,"selector":"@a[tag=nife_game_1,tag=town_rank2]"}]
tellraw @a [{"text":"| ","color":"gray","bold":"true"},{"translate":"tg.endgame.rank3","color":"green","bold":true},{"color":"green","bold":true,"selector":"@a[tag=nife_game_1,tag=town_rank3]"}]
tellraw @a [{"text":"| ","color":"gray","bold":"true"}]
tellraw @a [{"color":"dark_aqua","bold":"true","text":"Towngame"},{"color":"gray","bold":"true","text":" >> "},{"color":"green","bold":"true","translate":"tg.endgame.boardcast"},{"selector":"@a[tag=nife_game_1,tag=town_rank1]"},{"text":" !"}]
#重置玩家数据
